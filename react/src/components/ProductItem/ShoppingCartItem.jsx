...
export default function ShoppingCartItem({item,handleDeleteItem,handleBuyItem,addItem,removeItem}){
    
   const notify = () => toast("Successfully add item to the cart");

   const deleteItem=()=> toast("Successfully remove item to the cart");
       ...
       <h2>{item.name}</h2>
        ...
        <p>
         ...
         <div className="btnContainer">
                                        ...
                                        <input type="number"
                                               disabled
                                               className="cart-quantity" data-testid="cart-quantity" value={item.quantity}/>
        ...
        {/* <button className="add-to-cart js-add-to-cart btn" onClick={()=>handleBuyItem(item._id)} disabled={item.isBought ? true : false}>
              <span>Buy</span>
        ...
        <div className="shopping-cart__item-actions">
           ...
           <button className="shopping-cart__item--remove-btn" onClick={()=>handleDeleteItem(item._id)}>
              <span>Remove</span>
